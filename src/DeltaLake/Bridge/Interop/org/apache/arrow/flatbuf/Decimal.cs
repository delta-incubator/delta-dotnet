...
public struct Decimal : IFlatbufferObject
{
  ...
  public static Offset<org.apache.arrow.flatbuf.Decimal> CreateDecimal(FlatBufferBuilder builder,
      int precision = 0,
      int scale = 0,
      int bitWidth = 128) {
  ...
  public static Offset<org.apache.arrow.flatbuf.Decimal> EndDecimal(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<org.apache.arrow.flatbuf.Decimal>(o);
  }
}


static public class DecimalVerify
{
