...
/// list values.
public struct ListView : IFlatbufferObject
{
  private Table __p;
  ...
  public static Offset<org.apache.arrow.flatbuf.ListView> EndListView(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<org.apache.arrow.flatbuf.ListView>(o);
  }
}


static public class ListViewVerify
{
