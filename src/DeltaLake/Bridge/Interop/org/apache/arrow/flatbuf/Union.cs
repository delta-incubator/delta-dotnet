...
public struct Union : IFlatbufferObject
{
  ...
  public org.apache.arrow.flatbuf.UnionMode Mode { get { int o = __p.__offset(4); return o != 0 ? (org.apache.arrow.flatbuf.UnionMode)__p.bb.GetShort(o + __p.bb_pos) : org.apache.arrow.flatbuf.UnionMode.Sparse; } }
  ...
  public static Offset<org.apache.arrow.flatbuf.Union> CreateUnion(FlatBufferBuilder builder,
  ...
  public static void AddMode(FlatBufferBuilder builder, org.apache.arrow.flatbuf.UnionMode mode) { builder.AddShort(0, (short)mode, 0); }
  ...
  public static Offset<org.apache.arrow.flatbuf.Union> EndUnion(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<org.apache.arrow.flatbuf.Union>(o);
  }
}
...
static public class UnionVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Mode*/, 2 /*org.apache.arrow.flatbuf.UnionMode*/, 2, false)
