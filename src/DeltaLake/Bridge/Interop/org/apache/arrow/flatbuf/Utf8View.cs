...
public struct Utf8View : IFlatbufferObject
{
  private Table __p;
  ...
  public static Offset<org.apache.arrow.flatbuf.Utf8View> EndUtf8View(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<org.apache.arrow.flatbuf.Utf8View>(o);
  }
}


static public class Utf8ViewVerify
{
