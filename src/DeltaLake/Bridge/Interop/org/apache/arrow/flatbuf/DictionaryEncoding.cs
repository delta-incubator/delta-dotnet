...
static public class DictionaryEncodingVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*Id*/, 8 /*long*/, 8, false)
      && verifier.VerifyTable(tablePos, 6 /*IndexType*/, org.apache.arrow.flatbuf.IntVerify.Verify, false)
      && verifier.VerifyField(tablePos, 8 /*IsOrdered*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 10 /*DictionaryKind*/, 2 /*org.apache.arrow.flatbuf.DictionaryKind*/, 2, false)
