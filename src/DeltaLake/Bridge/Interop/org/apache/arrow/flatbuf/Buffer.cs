...
public struct Buffer : IFlatbufferObject
{
  ...
  public static Offset<org.apache.arrow.flatbuf.Buffer> CreateBuffer(FlatBufferBuilder builder, long Offset, long Length) {
    builder.Prep(8, 16);
    builder.PutLong(Length);
    builder.PutLong(Offset);
    return new Offset<org.apache.arrow.flatbuf.Buffer>(builder.Offset);
  }
}
